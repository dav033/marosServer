...
public abstract class BaseService<D, ID, E, R extends JpaRepository<E, ID>> implements CrudService<D, ID> {

        protected final R repository;
        protected final GenericMapper<D, E> mapper;

        protected BaseService(R repository, GenericMapper<D, E> mapper) {
